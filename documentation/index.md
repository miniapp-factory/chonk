...
- ALWAYS ensure that the [title and description](../mini-app/lib/metadata.ts) and [the app logo](../mini-app/public/icon.png.done) represent the current functionality of the app.
